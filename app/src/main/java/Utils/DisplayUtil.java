...
public class DisplayUtil {
    ...
    public static final float SCALE_NEEDLE_MARGIN_TOP = (float) (47.0 / BASE_SCREEN_HEIGHT);

    /*唱盘比例*/
    public static final float SCALE_DISC_SIZE = (float) (2000.0 / BASE_SCREEN_WIDTH);
