...
public class SongListDetailActivity extends BaseActivity implements SongDetailAdapter.OnItemClickListener, OnPlayerEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tag = intent.getBundleExtra("song").getString("tag");
        ...
        recyclerView = findViewById(R.id.songlistdetail_recycler);
        ...
        public_time = findViewById(R.id.public_time);
        singerMore = findViewById(R.id.singer_more);
        author_image = findViewById(R.id.author_image);
        toolbar = findViewById(R.id.title_toolbar);
        head_background = findViewById(R.id.head_background);
        scrollView = findViewById(R.id.scroll_view);
        title_imagebg = findViewById(R.id.title_imagebg);
    ...
    private void setImgHeaderBg(String imgUrl) {
        if (!TextUtils.isEmpty(imgUrl)) {
            ...
            ViewGroup.LayoutParams params = title_imagebg.getLayoutParams();
